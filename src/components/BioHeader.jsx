  ...
  return (
    <section id="bio-header" className="w-full">
      <div className="max-w-content mx-auto px-6">
        ...
        <ul className="pl-5 text-[15px] leading-relaxed text-muted list-disc mb-10">
        ...
        <div className="flex items-baseline justify-start mt-8">
          <div className="font-semibold tracking-wide text-lg">项目经历</div>
        </div>
        <div className="h-px bg-border my-4 mb-6"></div>
